...
const FRAME_PATHS = [
  ...
  "M308.219 97.0298C309.154 97.0298 309.918 97.7958 309.918 98.7319L309.918 177.123C309.918 178.06 309.154 178.826 308.219 178.826L243.298 178.826C242.363 178.826 241.599 178.06 241.599 177.123L241.599 98.7319C241.599 97.7957 242.363 97.0298 243.298 97.0298L308.219 97.0298ZM308.219 93.6255L243.298 93.6255C240.487 93.6255 238.202 95.9149 238.202 98.7319L238.202 177.123C238.202 179.94 240.487 182.23 243.298 182.23L308.219 182.23C311.03 182.23 313.315 179.94 313.315 177.123L313.315 93.6255 308.219 93.6255Z",
] as const;

const OUTER_BORDER_PATH_DATA =
  "M 5 3.4 H 315.9 A 1.7 1.7 0 0 1 317.6 5.1 V 194.9 A 1.7 1.7 0 0 1 315.9 196.6 H 5 A 1.7 1.7 0 0 1 3.4 194.9 V 5.1 A 1.7 1.7 0 0 1 5 3.4 Z";
